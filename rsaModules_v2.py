...
class rsaBlock(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.theta_conv = nn.Conv2d(in_channels, in_channels, 1, 1, 0)
        self.phi_conv   = nn.Conv2d(in_channels, in_channels, 1, 1, 0)
        self.g_conv     = nn.Conv2d(in_channels, in_channels, 1, 1, 0)
        ...
        self.axial_beta    = nn.Parameter(torch.tensor(0.0, requires_grad = True))
    ...
    def forward(self, x):
        ...
        x = x + self.axial_sa(theta_x, phi_x, g_x) * self.axial_beta
