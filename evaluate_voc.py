...
def main():
    ...
    model.load_state_dict(torch.load("/home/mel/tingwei/PE_seg/AdvSemiSeg/snapshots/0125g_hr_hu150.pth"))
    ...
    for index, batch in enumerate(testloader):
        ...
        for i in range(len(output_mask)):
                    for c in range(1):
                        filename = os.path.join(args.save_dir, '{}.png'.format(name[0].split('/')[6] +'_'+ name[0].split('/')[7] +'_'+ name[0].split('/')[8]))
